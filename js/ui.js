...
export const VERSION = "20260910l";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260910l";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, wikiURL,
} from "./sources.js?v=20260910l";
import {
  makeBlank, makeDescriptive,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260910l";
import { CASES } from "./cases.js?v=20260910l";
import { HANREI } from "./hanrei.js?v=20260910l";
import { JOUBUN } from "./joubun.js?v=20260910l";
