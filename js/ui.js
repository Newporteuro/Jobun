...
export const VERSION = "20260831e";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260831e";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, parseDoctrines, wikiURL,
} from "./sources.js?v=20260831e";
import {
  makeBlank, makeDescriptive, makeDoctrine,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260831e";
import { CASES } from "./cases.js?v=20260831e";
import { HANREI } from "./hanrei.js?v=20260831e";
import { JOUBUN } from "./joubun.js?v=20260831e";
