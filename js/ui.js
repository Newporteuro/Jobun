...
export const VERSION = "20260829c";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260829c";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, parseDoctrines, wikiURL,
} from "./sources.js?v=20260829c";
import {
  makeBlank, makeDescriptive, makeDoctrine,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260829c";
import { CASES } from "./cases.js?v=20260829c";
import { HANREI } from "./hanrei.js?v=20260829c";
import { JOUBUN } from "./joubun.js?v=20260829c";
