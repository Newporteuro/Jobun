...
export const VERSION = "20260830a";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260830a";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, parseDoctrines, wikiURL,
} from "./sources.js?v=20260830a";
import {
  makeBlank, makeDescriptive, makeDoctrine,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260830a";
import { CASES } from "./cases.js?v=20260830a";
import { HANREI } from "./hanrei.js?v=20260830a";
import { JOUBUN } from "./joubun.js?v=20260830a";
