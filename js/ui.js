...
export const VERSION = "20260826o";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260826o";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, parseDoctrines, wikiURL,
} from "./sources.js?v=20260826o";
import {
  makeBlank, makeDescriptive, makeDoctrine,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260826o";
import { CASES } from "./cases.js?v=20260826o";
import { HANREI } from "./hanrei.js?v=20260826o";
