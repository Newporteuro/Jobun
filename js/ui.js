...
export const VERSION = "20260825r";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260825r";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, parseDoctrines, wikiURL,
} from "./sources.js?v=20260825r";
import {
  makeBlank, makeDescriptive, makeDoctrine,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260825r";
import { CASES } from "./cases.js?v=20260825r";
import { HANREI } from "./hanrei.js?v=20260825r";
