...
export const VERSION = "20260910s";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260910s";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, wikiURL,
} from "./sources.js?v=20260910s";
import {
  makeBlank, makeDescriptive,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260910s";
import { CASES } from "./cases.js?v=20260910s";
import { HANREI } from "./hanrei.js?v=20260910s";
import { JOUBUN } from "./joubun.js?v=20260910s";
