...
export const VERSION = "20260923d";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260923d";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, wikiURL,
} from "./sources.js?v=20260923d";
import {
  makeBlank, makeDescriptive,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260923d";
import { CASES } from "./cases.js?v=20260923d";
import { HANREI } from "./hanrei.js?v=20260923d";
import { JOUBUN } from "./joubun.js?v=20260923d";
