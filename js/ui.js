...
export const VERSION = "20260910d";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260910d";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, parseDoctrines, wikiURL,
} from "./sources.js?v=20260910d";
import {
  makeBlank, makeDescriptive, makeDoctrine,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260910d";
import { CASES } from "./cases.js?v=20260910d";
import { HANREI } from "./hanrei.js?v=20260910d";
import { JOUBUN } from "./joubun.js?v=20260910d";
