...
export const VERSION = "20260919b";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260919b";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, wikiURL,
} from "./sources.js?v=20260919b";
import {
  makeBlank, makeDescriptive,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260919b";
import { CASES } from "./cases.js?v=20260919b";
import { HANREI } from "./hanrei.js?v=20260919b";
import { JOUBUN } from "./joubun.js?v=20260919b";
