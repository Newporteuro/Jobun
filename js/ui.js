...
export const VERSION = "20260825z";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260825z";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, parseDoctrines, wikiURL,
} from "./sources.js?v=20260825z";
import {
  makeBlank, makeDescriptive, makeDoctrine,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260825z";
import { CASES } from "./cases.js?v=20260825z";
import { HANREI } from "./hanrei.js?v=20260825z";
