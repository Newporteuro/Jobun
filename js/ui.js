...
export const VERSION = "20260831c";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260831c";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, parseDoctrines, wikiURL,
} from "./sources.js?v=20260831c";
import {
  makeBlank, makeDescriptive, makeDoctrine,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260831c";
import { CASES } from "./cases.js?v=20260831c";
import { HANREI } from "./hanrei.js?v=20260831c";
import { JOUBUN } from "./joubun.js?v=20260831c";
...
const PICK_SECTION = ["人権", "統治", "行為", "行手", "行不", "行訴", "国賠", "損失", "地自"];
function pickOrd(g) {
