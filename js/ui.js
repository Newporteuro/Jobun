...
export const VERSION = "20260910k";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260910k";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, wikiURL,
} from "./sources.js?v=20260910k";
import {
  makeBlank, makeDescriptive,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260910k";
import { CASES } from "./cases.js?v=20260910k";
import { HANREI } from "./hanrei.js?v=20260910k";
import { JOUBUN } from "./joubun.js?v=20260910k";
