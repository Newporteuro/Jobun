...
export const VERSION = "20260923i";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260923i";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, wikiURL,
} from "./sources.js?v=20260923i";
import {
  makeBlank, makeDescriptive,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260923i";
import { CASES } from "./cases.js?v=20260923i";
import { HANREI } from "./hanrei.js?v=20260923i";
import { JOUBUN } from "./joubun.js?v=20260923i";
