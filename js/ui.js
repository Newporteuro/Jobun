...
export const VERSION = "20260924a";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260924a";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, wikiURL,
} from "./sources.js?v=20260924a";
import {
  makeBlank, makeDescriptive,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260924a";
import { CASES } from "./cases.js?v=20260924a";
import { HANREI } from "./hanrei.js?v=20260924a";
import { JOUBUN } from "./joubun.js?v=20260924a";
