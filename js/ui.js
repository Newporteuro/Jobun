...
export const VERSION = "20260923c";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260923c";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, wikiURL,
} from "./sources.js?v=20260923c";
import {
  makeBlank, makeDescriptive,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260923c";
import { CASES } from "./cases.js?v=20260923c";
import { HANREI } from "./hanrei.js?v=20260923c";
import { JOUBUN } from "./joubun.js?v=20260923c";
