...
import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260923j";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, wikiURL,
} from "./sources.js?v=20260923j";
import {
  makeBlank, makeDescriptive,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260923j";
import { CASES } from "./cases.js?v=20260923j";
import { HANREI } from "./hanrei.js?v=20260923j";
import { JOUBUN } from "./joubun.js?v=20260923j";
