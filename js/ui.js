...
export const VERSION = "20260827a";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260827a";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, parseDoctrines, wikiURL,
} from "./sources.js?v=20260827a";
import {
  makeBlank, makeDescriptive, makeDoctrine,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260827a";
import { CASES } from "./cases.js?v=20260827a";
import { HANREI } from "./hanrei.js?v=20260827a";
