...
export const VERSION = "20260830m";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260830m";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, parseDoctrines, wikiURL,
} from "./sources.js?v=20260830m";
import {
  makeBlank, makeDescriptive, makeDoctrine,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260830m";
import { CASES } from "./cases.js?v=20260830m";
import { HANREI } from "./hanrei.js?v=20260830m";
import { JOUBUN } from "./joubun.js?v=20260830m";
