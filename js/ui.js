...
export const VERSION = "20260910j";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260910j";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, wikiURL,
} from "./sources.js?v=20260910j";
import {
  makeBlank, makeDescriptive,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260910j";
import { CASES } from "./cases.js?v=20260910j";
import { HANREI } from "./hanrei.js?v=20260910j";
import { JOUBUN } from "./joubun.js?v=20260910j";
