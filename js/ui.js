...
export const VERSION = "20260828d";

import { LAWS, SCOPES, weightOf } from "./weights.js?v=20260828d";
import {
  fetchArticle, fetchIndex, renderArticle, fullText,
  fetchWikitext, parsePrecedents, parseDoctrines, wikiURL,
} from "./sources.js?v=20260828d";
import {
  makeBlank, makeDescriptive, makeDoctrine,
  isPoorQuestion, similarity, scoreCase, weightedPick, pick,
} from "./drill.js?v=20260828d";
import { CASES } from "./cases.js?v=20260828d";
import { HANREI } from "./hanrei.js?v=20260828d";
import { JOUBUN } from "./joubun.js?v=20260828d";
